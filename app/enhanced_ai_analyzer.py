...
class EnhancedAIAnalyzer:
    ...
    def _get_completion(self, prompt: str, timeout: int = 90) -> str:
        ...
        try:
            ...
            system_msg = (
                ...
                "Use plain prose only (no markdown, no **bold**, no JSON or code fences)."
            )
...
Provide evidence-based technical analysis with specific examples.
    ...
    def generate_detailed_ai_analysis(self, shoe: Dict[str, Any], request: RecommendationRequest, rank: int = 1) -> tuple[str, list[str]]:
        ...
        try:
            ...
            text = (detailed_analysis.rstrip() + ranking_note).strip()
            return text, sources
